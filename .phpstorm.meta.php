...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/logcomex/Documentos/frelas/nexus/public/storage' => 'string',
...
'app.aliases.View','app.aliases.Vite','app.debug_secret','auth.defaults.guard','auth.defaults.passwords',
...
'filesystems.disks.s3.report','filesystems.links./home/logcomex/Documentos/frelas/nexus/public/storage','fortify.guard','fortify.middleware','fortify.auth_middleware',
...
'two-factor.qr-code','two-factor.secret-key','two-factor.recovery-codes','two-factor.regenerate-recovery-codes','home','dashboard',
'bank-accounts.index','payments.index','payments.create','payments.store','payments.edit',
'payments.update','payments.destroy','payments.attachment','payment-statuses.index','payment-statuses.store',
'payment-types.index','expenses.index','expenses.create','expenses.store','expenses.edit',
'expenses.update','expenses.destroy','expenses.payment-options','expense-statuses.index','expense-statuses.store',
'works.index','works.create','works.store','works.edit','works.update',
'works.destroy','works.options','cost-centers.index','cost-centers.create','cost-centers.store',
'cost-centers.edit','cost-centers.update','cost-centers.destroy','expenses.payment-options','cost-center-types.index',
'cost-center-types.store','payees.index','payees.create','payees.store','payees.edit',
'payees.update','payees.destroy','payees.options','profile.edit',
...
'validation.attributes.birth_date','validation.attributes.code','validation.attributes.start_date','validation.attributes.expected_end_date','validation.attributes.budget',
'validation.attributes.work_id','validation.attributes.cost_center_type_id','validation.attributes.cost_center_id','validation.attributes.document','validation.attributes.document_type',
'validation.attributes.pix_key','validation.attributes.pix_type','validation.attributes.is_active','validation.attributes.is_pix_document','validation.attributes.reference',
'validation.attributes.payee_id','validation.attributes.amount','validation.attributes.due_at','validation.attributes.competence_date','validation.attributes.expense_status_id',
'validation.attributes.expense_category_id','validation.attributes.expense_id','validation.attributes.bank_id','validation.attributes.bank_account_id','validation.attributes.payment_status_id',
'validation.attributes.payment_type_id','validation.attributes.paid_at',);
        registerArgumentsSet('env', 
'APP_NAME','APP_ENV','APP_KEY','DEBUG_SECRET','APP_DEBUG',
'APP_URL','APP_TIMEZONE','APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE',
...
'SESSION_ENCRYPT','SESSION_PATH','SESSION_DOMAIN','SESSION_SECURE_COOKIE','BROADCAST_CONNECTION',
